...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2015 at 10:57 AM
...
INSERT INTO `benefit` (`benefit_id`, `benefit_amount`, `benefit_scholarShare`, `benefit_tuitionfee_id`, `benefit_scholar_id`, `benefit_school_id`) VALUES
...
INSERT INTO `grades` (`grade_id`, `grade_schoolYear`, `grade_Term`, `grade_scholar_id`, `grade_value`) VALUES
(17, 4, 3, 2, '4.0');
...
CREATE TABLE IF NOT EXISTS `uploadedforms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `scholar_lastName` varchar(100) DEFAULT NULL,
  `scholar_firstName` varchar(100) DEFAULT NULL,
  `scholar_middleName` varchar(100) DEFAULT NULL,
