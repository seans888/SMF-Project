...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2015 at 05:45 PM
...
`grade_id` int(11) NOT NULL,
  ...
  `grade_approval_status` enum('Approved','Not Approved') NOT NULL,
...
`scholar_id` int(11) NOT NULL,
  ...
  `scholar_middle_name` varchar(100) NOT NULL,
  `scholar_last_name` varchar(100) NOT NULL,
  `scholar_gender` enum('Male','Female') NOT NULL,
  `scholar_address` varchar(255) NOT NULL,
  `scholar_course` varchar(100) NOT NULL,
  `scholar_graduate_status` enum('Graduated','Not Graduated') NOT NULL,
  `scholar_year_level` int(11) NOT NULL,
  `scholar_contact_email` varchar(100) NOT NULL,
  `scholar_contact_number` varchar(100) NOT NULL,
  `scholar_allowance_status` enum('Granting','Withheld') NOT NULL,
  `scholar_cash_card_number` varchar(45) NOT NULL,
  `scholar_type` enum('SMFI','My Scholar A','Kabayan Scholar','My Scholar B','ICA Grant Scholar') NOT NULL,
  `scholar_sponsor` varchar(100) NOT NULL,
...
INSERT INTO `scholar` (`scholar_id`, `school_school_id`, `scholar_first_name`, `scholar_middle_name`, `scholar_last_name`, `scholar_gender`, `scholar_address`, `scholar_course`, `scholar_graduate_status`, `scholar_year_level`, `scholar_contact_email`, `scholar_contact_number`, `scholar_allowance_status`, `scholar_cash_card_number`, `scholar_type`, `scholar_sponsor`, `allowance_allowance_area`, `scholar_user_id`) VALUES
(1, 1, 'Syam', 'Uy Sobierra', 'Daswani', 'Male', 'address', 'BSIT-MI', 'Not Graduated', 4, 'syam@email.com', '12345', 'Granting', '123', 'SMFI', 'Sponsor 1', 'NCR', 2);
...
(2, 'De Lasalle University', 'Abra', 'lasalle address', 'dlsu@email.com', '12345', 'b'),
...
`subject_id` int(11) NOT NULL,
  ...
  `subject_approval_status` enum('Approved','Not Approed') DEFAULT NULL,
...
--
ALTER TABLE `equivalence`
MODIFY `equivalence_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `optionalwork`
MODIFY `optionalwork_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `withholding`
MODIFY `withholding_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ADD CONSTRAINT `scholar_ibfk_3` FOREIGN KEY (`scholar_user_id`) REFERENCES `user` (`id`);
