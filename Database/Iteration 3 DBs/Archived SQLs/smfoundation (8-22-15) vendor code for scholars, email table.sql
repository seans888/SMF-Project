...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2015 at 03:39 PM
...
`scholar_id` int(11) NOT NULL,
  ...
  `scholar_allowance_status` enum('Granting','Withheld') DEFAULT NULL,
  `scholar_cash_card_number` varchar(45) DEFAULT NULL,
  `scholar_vendor_code` int(11) NOT NULL,
...
INSERT INTO `scholar` (`scholar_id`, `school_school_id`, `scholar_first_name`, `scholar_middle_name`, `scholar_last_name`, `scholar_gender`, `scholar_address`, `scholar_course`, `scholar_graduate_status`, `scholar_year_level`, `scholar_contact_email`, `scholar_contact_number`, `scholar_allowance_status`, `scholar_cash_card_number`, `scholar_vendor_code`, `scholar_type`, `scholar_sponsor`, `allowance_allowance_area`, `scholar_user_id`) VALUES
(1, 1, 'Syam', 'Uy Sobierra', 'Daswani', 'Male', 'syam''s address', 'BSIT-MI', 'Graduated', 1, 'syam@email.com', '12344', 'Granting', '123', 123123, 'SMFI', 'sponsor1', 'NCR', 2),
(2, 1, 'Kevin', 'Gonzaga', 'Villacorta', 'Male', 'kevin''s address', 'BSIT-MI', 'Not Graduated', 1, 'kevin''s email', '12345', 'Granting', '123', 456456, 'SMFI', 'sponsor1', 'NCR', 3);
...
(2, 'De Lasalle University', 'Provincial', 'school address', 'dlsu@email.com', '12345', 'b'),
...
--
ALTER TABLE `email`
 ADD PRIMARY KEY (`email_id`), ADD KEY `email_scholar_id` (`email_scholar_id`);
...
--
ALTER TABLE `optionalwork`
MODIFY `optionalwork_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tuition`
MODIFY `tuition_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
ADD CONSTRAINT `grade_ibfk_2` FOREIGN KEY (`subject_scholar_scholar_id`) REFERENCES `scholar` (`scholar_id`) ON UPDATE CASCADE,
