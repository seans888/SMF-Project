...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2015 at 10:34 AM
...
ALTER TABLE `deduction`
  ADD PRIMARY KEY (`deduction_id`,`scholar_scholar_id`,`scholar_school_school_id`), ADD KEY `fk_deduction_scholar1_idx` (`scholar_scholar_id`,`scholar_school_school_id`);

--
-- Indexes for table `equivalence`
--
ALTER TABLE `equivalence`
  ADD PRIMARY KEY (`equivalence_id`,`school_school_id`), ADD KEY `fk_equivalence_school1_idx` (`school_school_id`);

--
-- Indexes for table `grade`
--
ALTER TABLE `grade`
  ADD PRIMARY KEY (`grade_id`,`subject_subject_id`,`subject_scholar_scholar_id`,`subject_scholar_school_school_id`), ADD KEY `fk_grade_subject1_idx` (`subject_subject_id`,`subject_scholar_scholar_id`,`subject_scholar_school_school_id`);

--
-- Indexes for table `incentive`
--
ALTER TABLE `incentive`
  ADD PRIMARY KEY (`incentive_id`,`scholar_scholar_id`,`scholar_school_school_id`,`scholar_allowance_allowance_area`), ADD KEY `fk_incentive_scholar1_idx` (`scholar_scholar_id`,`scholar_school_school_id`,`scholar_allowance_allowance_area`);
...
ALTER TABLE `optionalwork`
  ADD PRIMARY KEY (`optionalwork_id`,`scholar_scholar_id`,`scholar_school_school_id`), ADD KEY `fk_optionalwork_scholar1_idx` (`scholar_scholar_id`,`scholar_school_school_id`);

--
-- Indexes for table `scholar`
--
ALTER TABLE `scholar`
  ADD PRIMARY KEY (`scholar_id`,`school_school_id`,`allowance_allowance_area`), ADD KEY `fk_scholar_school_idx` (`school_school_id`), ADD KEY `fk_scholar_allowance1_idx` (`allowance_allowance_area`);
...
--
ALTER TABLE `subject`
  ADD PRIMARY KEY (`subject_id`,`scholar_scholar_id`,`scholar_school_school_id`), ADD KEY `fk_subject_scholar1_idx` (`scholar_scholar_id`,`scholar_school_school_id`);

--
-- Indexes for table `tuition`
--
ALTER TABLE `tuition`
  ADD PRIMARY KEY (`tuition_id`,`scholar_scholar_id`,`scholar_school_school_id`), ADD KEY `fk_tuition_scholar1_idx` (`scholar_scholar_id`,`scholar_school_school_id`);

--
-- Indexes for table `upload`
--
ALTER TABLE `upload`
  ADD PRIMARY KEY (`upload_id`,`scholar_scholar_id`,`scholar_school_school_id`), ADD KEY `fk_upload_scholar1_idx` (`scholar_scholar_id`,`scholar_school_school_id`);
...
ALTER TABLE `withholding`
  ADD PRIMARY KEY (`withholding_id`,`scholar_scholar_id`,`scholar_school_school_id`,`scholar_allowance_allowance_area`), ADD KEY `fk_withholding_scholar1_idx` (`scholar_scholar_id`,`scholar_school_school_id`,`scholar_allowance_allowance_area`);
