...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2015 at 03:12 PM
...
INSERT INTO `allowance` (`allowance_id`, `allowance_amount`, `allowance_remark`, `allowance_scholar_id`, `allowance_school_id`, `allowance_payStatus`, `allowance_paidDate`) VALUES
(1, '2000.00', 'Allowance', 2, 1, 'not paid', '2015-07-25'),
(2, '1000.00', 'test', 3, 1, 'paid', '2015-07-14'),
(3, '5000.00', 'remark1', 2, 1, 'paid', '2015-07-29');
...
CREATE TABLE IF NOT EXISTS `benefit` (
  ...
  `benefit_scholar_id` int(11) NOT NULL,
  `benefit_allowance_id` int(11) DEFAULT NULL,
  `benefit_refund_id` int(11) DEFAULT NULL,
  `benefit_deduction_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`benefit_id`),
  KEY `benefit_allowance_id` (`benefit_allowance_id`,`benefit_refund_id`,`benefit_deduction_id`),
  KEY `benefit_scholar_id` (`benefit_scholar_id`),
  KEY `benefit_refund_id` (`benefit_refund_id`),
  KEY `benefit_deduction_id` (`benefit_deduction_id`)
...
INSERT INTO `benefit` (`benefit_id`, `benefit_scholar_id`, `benefit_allowance_id`, `benefit_refund_id`, `benefit_deduction_id`) VALUES
(1, 2, 1, 1, 3),
(2, 3, 2, NULL, NULL),
(3, 2, 3, 2, NULL),
(4, 5, NULL, NULL, 2),
...
CREATE TABLE IF NOT EXISTS `deductions` (
  ...
  KEY `deduction_scholar_id` (`deduction_scholar_id`)
...
(2, '2015-07-16', '1000.00', 'Failed Subject 8', 5),
(3, '2015-07-03', '1000.00', 'Repeated Data Structures', 2);
...
CREATE TABLE IF NOT EXISTS `equivalence` (
  `equivalence_grade_rule` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`equivalence_grade_rule`),
...
CREATE TABLE IF NOT EXISTS `grades` (
  ...
  KEY `equivalence_grade_rule` (`equivalence_grade_rule`),
  KEY `School_id` (`School_id`)
...
(17, 2015, 1, 4, 'Subject1', '3.00', '4.0', 1, 1),
(18, 2015, 1, 4, 'Subject2', '3.00', '4.0', 1, 1),
...
(49, 2015, 1, 8, 'Subject 1', '3.00', '1.0', 24, 3),
(50, 2015, 1, 8, 'Subject 2', '3.00', '1.0', 24, 3),
(51, 2015, 1, 8, 'Subject 3', '3.00', '1.0', 24, 3),
(52, 2015, 1, 8, 'Subject 4', '3.00', '1.0', 24, 3),
(53, 2015, 2, 8, 'Subject 5', '3.00', '1.25', 25, 3),
(54, 2015, 2, 8, 'Subject 6', '3.00', '1.25', 25, 3),
(55, 2015, 2, 8, 'Subject 7', '3.00', '1.5', 26, 3),
(56, 2015, 2, 8, 'Subject 8', '3.00', '1.5', 26, 3),
(57, 2015, 1, 9, 'Subject 1', '3.00', '1.0', 24, 3),
(58, 2015, 1, 9, 'Subject 2', '3.00', '1.0', 24, 3),
(59, 2015, 1, 9, 'Subject 3', '3.00', '1.0', 24, 3),
(60, 2015, 1, 9, 'Subject 4', '3.00', '1.0', 24, 3),
(61, 2015, 2, 9, 'Subject 5', '3.00', '1.25', 25, 3),
(62, 2015, 2, 9, 'Subject 6', '3.00', '1.25', 25, 3),
(63, 2015, 2, 9, 'Subject 7', '3.00', '1.5', 26, 3),
(64, 2015, 2, 9, 'Subject 8', '3.00', '1.5', 26, 3),
...
(81, 2015, 1, 12, 'Subject 1', '3.00', '1.0', 46, 5),
(82, 2015, 1, 12, 'Subject 2', '3.00', '1.0', 46, 5),
(83, 2015, 1, 12, 'Subject 3', '3.00', '1.0', 46, 5),
(84, 2015, 1, 12, 'Subject 4', '3.00', '1.0', 46, 5),
(85, 2015, 2, 12, 'Subject 5', '3.00', '1.25', 47, 5),
(86, 2015, 2, 12, 'Subject 6', '3.00', '1.25', 47, 5),
(87, 2015, 2, 12, 'Subject 7', '3.00', '1.5', 48, 5),
(88, 2015, 2, 12, 'Subject 8', '3.00', '1.5', 48, 5),
(89, 2015, 1, 13, 'Subject 1', '3.00', '1.0', 46, 5),
(90, 2015, 1, 13, 'Subject 2', '3.00', '1.0', 46, 5),
(91, 2015, 1, 13, 'Subject 3', '3.00', '1.0', 46, 5),
(92, 2015, 1, 13, 'Subject 4', '3.00', '1.0', 46, 5),
(93, 2015, 2, 13, 'Subject 5', '3.00', '1.25', 47, 5),
(94, 2015, 2, 13, 'Subject 6', '3.00', '1.25', 47, 5),
(95, 2015, 2, 13, 'Subject 7', '3.00', '1.5', 48, 5),
(96, 2015, 2, 13, 'Subject 8', '3.00', '1.5', 48, 5);
...
CREATE TABLE IF NOT EXISTS `refunds` (
  ...
  KEY `refund_scholar_id` (`refund_scholar_id`,`refund_tuitionfee_id`),
  KEY `refund_tuitionfee_id` (`refund_tuitionfee_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;
...
INSERT INTO `scholars` (`scholar_id`, `scholar_firstName`, `scholar_lastName`, `scholar_middleName`, `scholar_gender`, `scholar_address`, `scholar_school_id`, `scholar_course`, `scholar_yearLevel`, `scholar_email`, `scholar_contactNum`, `scholar_cashCardNum`, `scholar_school_area`, `scholar_sponsors`, `scholar_user_id`) VALUES
(2, 'Syam', 'Daswani', 'Uy Sobierra', 'Male', 'some address', 1, 'BSIT-MI', 4, 'syam@email.com', 1234, 1234, 'NCR', 'Sponsor 1', 2),
(3, 'Kevin', 'Villacorta', 'dafsdf', 'Male', 'address', 1, 'BSIT-MI', 4, 'kevin@email.com', 1234, 12321, 'NCR', NULL, 3),
(4, 'Cindy', 'Cabaliza', 'P.', 'Female', 'Scholar Cindy''s address', 1, 'BSA', 5, 'cindyC@gmail.com', 9111111, 9111111, 'Provincial', NULL, 4),
(5, 'Allona Kriztel', 'Aguirre', 'F.', 'Female', 'scholar Allona''s Address', 1, 'BSA', 3, 'allona@gmail.com', 9222222, 9222222, 'Provincial', 'Sponsor 2', 5),
(6, 'Louise Ann', 'Tan', 'U.', 'Female', 'scholar Louise''s Address', 2, 'BS Marketing', 4, 'louise@gmail.com', 93333333, 93333333, 'NCR', NULL, 6),
(7, 'Kim Joshua ', 'Garces', 'B. ', 'Male', 'scholar Kim''s address ', 2, 'BSBA Financial Management', 3, 'kim@gmail.com', 944444444, 944444444, 'NCR', NULL, 7),
(8, 'Isabela', 'Supnet', 'E.', 'Female', 'scholar Isabela''s Address', 3, 'Intramed', 7, 'isabelaS@gmail.com', 9555555, 9555555, 'NCR', NULL, 8),
(9, 'Kimberly', 'Go', NULL, 'Female', 'scholar Kimerly''s address', 3, 'BS Geography', 4, 'kimberlyG@gmail.com', 9666666, 9666666, 'NCR', NULL, 9),
(10, 'Camille Andrea', 'Sequitin', 'B.', 'Female', 'scholar Camille''s Address', 4, 'BS Computer Engineering', 5, 'camilleS@gmail.com', 9777777, 9777777, 'NCR', NULL, 10),
(11, 'Faye', 'Ramirez', 'M. ', 'Female', 'scholar Faye''s address', 4, 'BS Computer Engineering', 4, 'scholar Faye''s address', 98888888, 9888888, 'NCR', NULL, 11),
(12, 'Rother Jon', 'Bobiles', 'P.', 'Male', 'scholar Rother''s address', 5, 'BS Management Engineering', 3, 'rohter@gmail.com', 9999999, 9999999, 'Provincial', 'Sponsor 3', 12),
(13, 'Katrina', 'Aliman', 'G.', 'Female', 'scholar Katrina''s address', 5, 'BS Accountancy', 2, 'katrina@GMAIL.COM', 1000000, 1000000, 'Provincial', 'Sponsor 4', 13);
...
--
ALTER TABLE `benefit`
  ADD CONSTRAINT `benefit_ibfk_1` FOREIGN KEY (`benefit_scholar_id`) REFERENCES `scholars` (`scholar_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `benefit_ibfk_2` FOREIGN KEY (`benefit_allowance_id`) REFERENCES `allowance` (`allowance_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `benefit_ibfk_3` FOREIGN KEY (`benefit_refund_id`) REFERENCES `refunds` (`refund_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `benefit_ibfk_4` FOREIGN KEY (`benefit_deduction_id`) REFERENCES `deductions` (`deduction_id`) ON UPDATE CASCADE;
