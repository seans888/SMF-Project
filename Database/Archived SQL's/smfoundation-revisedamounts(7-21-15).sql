...
(1, '10000.00', 'Allowance', 2, 1, 'not paid', NULL, '2015-07-25'),
(2, '10000.00', 'test', 3, 1, 'paid', NULL, '2015-07-14');
...
CREATE TABLE IF NOT EXISTS `benefit` (
  ...
  `benefit_description` varchar(100) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
(1, '10000.00', 5000, NULL, 2, 1, ''),
(2, '20000.00', 10000, 5, 3, 1, ''),
(3, '10000.00', 5000, NULL, 3, 2, 'test');
...
(4, 'Ateneo De Davao University', 'NCR', 'Ateneo Address', NULL, 4266001),
...
(4, 2, '20000.00', NULL, NULL, 'paid'),
(5, 3, '20000.00', '2015-07-01', '2015-07-29', 'paid'),
(7, 2, '20000.00', '2015-07-02', '2015-08-07', 'paid');
...
(1, 'Forms/Grades Form2.png', 2, 'Grades Form');
