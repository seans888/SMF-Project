...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2015 at 01:48 PM
...
(1, 10000, 'Allowance', 2, 1, 'not paid', NULL, '2015-07-25'),
(2, 10000, 'test', 3, 1, 'paid', NULL, '2015-07-14');
...
(1, 10000, 5000, NULL, 2, 1, ''),
(2, 20000, 10000, 5, 3, 1, ''),
(3, 10000, 5000, NULL, 3, 2, 'test');
...
(7, 2, 20000, '2015-07-02', '2015-08-07', 'paid');
