...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2015 at 11:14 AM
...
CREATE TABLE IF NOT EXISTS `scholars` (
  ...
  `scholars_courseType` varchar(20) NOT NULL,
  `scholars_gradStatus` varchar(20) NOT NULL,
  `scholar_yearLevel` int(11) DEFAULT NULL,
  `scholar_email` varchar(100) DEFAULT NULL,
  `scholar_contactNum` int(100) NOT NULL,
  `scholars_allowanceStatus` varchar(20) NOT NULL,
...
INSERT INTO `tuitionfees` (`tuitionfee_id`, `tuitionfee_scholar_id`, `tuitionfees_term`, `tuitionfee_amount`, `tuitionfee_dateOfEnrollment`, `tuitionfee_dateOfPayment`, `tuitionfee_paidStatus`) VALUES
...
--
ALTER TABLE `benefit`
  ADD PRIMARY KEY (`benefit_id`), ADD KEY `benefit_allowance_id` (`benefit_allowance_id`,`benefit_refund_id`,`benefit_deduction_id`), ADD KEY `benefit_scholar_id` (`benefit_scholar_id`), ADD KEY `benefit_refund_id` (`benefit_refund_id`), ADD KEY `benefit_deduction_id` (`benefit_deduction_id`);
