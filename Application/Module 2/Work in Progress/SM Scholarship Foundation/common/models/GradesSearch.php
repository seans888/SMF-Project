...
class GradesSearch extends Grades
{
    ...
    public function rules()
    {
        return [
            ...
            [['grade_school_name','grade_subject', 'grade_units','grade_scholar_lastName', 'grade_scholar_firstName', 'grade_scholar_middleName', 'grade_value'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'scholars.scholar_lastName', $this->grade_scholar_lastName])
			...
			->andFilterWhere(['like', 'grade_school_name', $this->grade_units]);
