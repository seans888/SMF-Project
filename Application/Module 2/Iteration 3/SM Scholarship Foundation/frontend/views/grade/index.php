...
<div class="grade-index">
    ...
    <center><h1 style="margin-top:100px;"><strong><?= Html::encode($this->title) ?></h1></center><br>
  ...
  <?php 
   ...
   $items = [
    ...
    [
        'label'=>'<i class="glyphicon glyphicon-list-alt"></i><b> Grade Records',
	...
	[
        'label'=>'<i class="glyphicon glyphicon-pencil"></i><b> Input Grades',
        'content'=>$this->render('groupcreate'),
    ],
    [
        'label'=>'<i class="glyphicon glyphicon-thumbs-down"></i><b> Low/Fail Grade Explanation Form',
