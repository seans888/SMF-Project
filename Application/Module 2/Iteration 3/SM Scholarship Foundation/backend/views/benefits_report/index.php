...
$reportico = \Yii::$app->getModule('reportico');
        ...
        $engine->initial_project = "foundationreportsbenefits";            // Name of report project folder    
        $engine->initial_report = "Test";           // Name of report to run
